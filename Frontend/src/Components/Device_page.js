                  ...
                  <Tab label="Time Series"  icon={<TimelineIcon />}{...a11yProps(1)} />
                    ...
                    <Grid
                      ...
                      >
                         ...
                         <iframe src={this.state.url1} width="50%" height="500" title="exp" id="ifm"></iframe>
                         <iframe src={this.state.url1_1} width="50%" height="500" title="res_donut" id="ifm"></iframe>
                         <iframe src={this.state.url1_2} width="50%" height="500" title="top_and_least" id="ifm"></iframe>
                          <iframe src={this.state.url1_3} width="50%" height="500" title="res" id="ifm"></iframe>
                    </TabPanel>
                    ...
                    <iframe src={this.state.url2} width="50%" height="500" title="exp_series" id="ifm"></iframe>
                     <iframe src={this.state.url2_1} width="50%" height="500" title="allRes_TS" id="ifm"></iframe>
                      <iframe src={this.state.url2_2} width="50%" height="500" title="exp_till_date" id="ifm"></iframe>
                      <iframe src={this.state.url2_3} width="50%" height="500" title="top_least_timeseries" id="ifm"></iframe>
                      <iframe src={this.state.url2_4} width="50%" height="500" title="restime" id="ifm"></iframe>
                </TabPanel>
